...
- 단계 7 : create 함수에는 set이 있다.
- set 은 state 즉, count 를 즉, 값을 설정하는 기능
...
- get 은 state 즉, count 를 즉, 값을 읽는 기능
...
- 단계 11 : set ? 이상합니다.
  ...
  - zustand 는 객체 내부의 state 의 key 명을 기준으로 명시만 하면됨
  - key 명을 명시하고 새로운 값만 작성해 주면됨
  - State 객체를 ... 즉, spred 할 필요 없음

- 단계 12 : set 은 함수형태도 지원함
...
- 설치후 > 웹브라우저 F12 > Components 탭 > Setting(톱니모양) > Highlight updates when components render 활성
  <img width="492" height="357" alt="Image" src="https://github.com/user-attachments/assets/2f29e278-7fd6-4d95-a700-da1b02bb411e" />
  <img width="496" height="348" alt="Image" src="https://github.com/user-attachments/assets/f22e905a-9562-44ab-8852-7c75d3cd5505" />
...
- `src\stores\count.ts` 업데이트
- actions 키를 명시후, 기존 액션함수들을 묶어준다.
...
- `src\components\counter\Controller.tsx` 업데이트
