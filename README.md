...
- `Prettier - Code formatter 설치` 확장 프로그램 설치 필요
...
### 4.5. 명령어로 포맷팅을 한번에 실행하도록 스크립트 작성(선택사항)
...
### 6.3. 확장 프로그램 설정 (실제 생성은 X 참조만)

- `/.vsconde/extensions.json` 확장 프로그램 정의 내용 작성
...
### 6.4. VSCode Config 설정 (실제 생성은 X 참조만)
...
```bash
git remote add origin https://github.com/devdorong/(레파지토리 주소)
```
